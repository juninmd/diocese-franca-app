...
*   **UI/UX States**: Keep empty states helpful and empathetic to guide the user (e.g., "Puxa, não conseguimos carregar as igrejas agora. Tente novamente!" instead of "Erro ao carregar"). Changed network errors and empty search states to use empathetic texts, standardizing the "Puxa, ..." prefix across all screens. Ensure widths fit well on various screen scales.
