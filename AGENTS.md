...
*   **UI/UX States**: Keep empty states helpful and empathetic to guide the user (e.g., "Ops! Não encontramos paróquias com este nome." instead of "Nenhuma paróquia encontrada"). Ensure widths fit well on various screen scales.
