...
*   **UI/UX States**: Keep empty states helpful by guiding the user (e.g., "Nenhum padre encontrado na busca" instead of just "Nenhum"). Ensure widths fit well on various screen scales.
